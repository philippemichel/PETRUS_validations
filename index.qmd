...
`à l'interface vitrée` a tendance est être plus petite que la mesure `habituelle`. Pas de différence pour la mesure de la gaine.Mais la précision est la même, il n'y a pas de différence entre les variances des deux méthodes.
